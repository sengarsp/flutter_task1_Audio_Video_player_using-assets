  ...
  var body = Container(
    ...
    child: Column(children: <Widget>[
      ...
      DecorationImage(image:
        NetworkImage('https://github.com/sengarsp/logo/blob/master/download%20(11).jpg?raw=true'),
        fit: BoxFit.cover) ,
      ...
      Container(
        ...
        child: Text('Teri Meri Dosti -Darshan',style: TextStyle(fontSize: 26,fontWeight: FontWeight.bold,color: Colors.black),),
      ),
