    ...
    child: Column(children: <Widget>[
      ...
      decoration: BoxDecoration(image:
       DecorationImage(image:
        NetworkImage('https://github.com/sengarsp/logo/blob/master/download%20(10).jpg?raw=true'),
        fit:BoxFit.cover) ,
      ...
      Container(
        ...
        child: Text('Kar Har Maidan Fateh - Sukhwinder Singh  ',textAlign:TextAlign.center ,style: TextStyle(fontSize: 26,fontWeight: FontWeight.bold,color: Colors.black),),
      ),
