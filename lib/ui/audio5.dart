    ...
    child: Column(children: <Widget>[
      ...
      decoration: BoxDecoration(image:
       DecorationImage(image:
        NetworkImage('https://github.com/sengarsp/logo/blob/master/images%20(1).jpg?raw=true'),
        fit:BoxFit.cover) ,
      ...
      Container(
        ...
        child: Text('Ghar se nikalte hi - Arman Malik',style: TextStyle(fontSize: 26,fontWeight: FontWeight.bold,color: Colors.black),),
      ),
